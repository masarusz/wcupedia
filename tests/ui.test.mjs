...
import { buildBracket } from '../public/js/bracket.js?v=0.5.2';
import { foldCompact } from '../public/js/fold.js';
import { formatDate, formatMinute, tournamentTitle } from '../public/js/format.js?v=0.5.2';
import { parseRuby } from '../public/js/ruby.js';
import { AWARD_LABELS, STAGE_LABELS, STAGE_LABELS_BY_YEAR, STRINGS } from '../public/js/strings.js?v=0.5.2';
import { VERSION } from '../public/js/version.js?v=0.5.2';
import { applySquadChanges } from '../tools/lib/phase4.mjs';
import { awardTier } from '../public/js/views.js?v=0.5.2';
